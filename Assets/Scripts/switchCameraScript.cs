...
public class switchCameraScript : MonoBehaviour
{
    ...
    public GameObject cam4UI;
    public Button cam5Button;
    public GameObject cam5UI;
    ...
    void Start()
    {
        ...
        cam4Button.onClick.AddListener(openCam4);
        cam5Button.onClick.AddListener(openCam5);
    }
    ...
    void openCam1()
    {
        ...
        cam4UI.SetActive(false);
        cam5UI.SetActive(false);
    ...
    void openCam4()
    {
        ...
        cam2UI.SetActive(false);
        cam3UI.SetActive(false);
        cam4UI.SetActive(true);
        cam5UI.SetActive(false);
        Debug.Log("Camera 4 opened");
    }
    void openCam5()
    {
        cam1UI.SetActive(false);
        ...
        cam3UI.SetActive(false);
        cam4UI.SetActive(false);
        cam5UI.SetActive(true);
        Debug.Log("Camera 5 opened");
    }
}
